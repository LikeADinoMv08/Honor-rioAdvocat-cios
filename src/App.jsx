            ...
            {[
              ...
              <React.Fragment key={s}>
                <div className="flex flex-col items-center">
                  <div
                    className={`w-14 h-14 rounded-2xl flex items-center justify-center mb-2 transition-all ${step >= s ? "bg-gradient-to-br from-purple-600 to-blue-600 text-white shadow-lg scale-110" : "bg-slate-200 text-slate-400"}`}
                  >
                    <Icon className="w-7 h-7" />
                  </div>
                  <span
                    className={`font-bold text-sm ${step >= s ? "text-purple-600" : "text-slate-400"}`}
                  >
                    {label}
                  </span>
                </div>
                {i < arr.length - 1 && (
                  <div className="flex-1 h-2 mx-3 rounded-full bg-slate-200 overflow-hidden">
                    <div
                      className={`h-full bg-gradient-to-r from-purple-600 to-blue-600 transition-all duration-500 ${step > s ? "w-full" : "w-0"}`}
                    />
                  </div>
                )}
              </React.Fragment>
            ...
            <div className="bg-white/80 backdrop-blur-sm rounded-3xl shadow-2xl p-8 border border-purple-100">
              ...
              <div className="grid md:grid-cols-4 gap-4 mb-7">
                {[
                  ...
                  <div
                    key={label}
                    className={`bg-gradient-to-br ${cls} p-5 rounded-2xl text-white shadow-xl`}
                  >
